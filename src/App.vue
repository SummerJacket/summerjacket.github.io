    ...
    >
      ...
      <div class="relative z-10 max-w-4xl mx-auto px-8">
        ...
        <main>
          ...
          <div
            class="md:pt-8 grid row-gap-8 md:row-gap-12 max-w-3xl -mx-4 sm:mx-auto"
          >
            <project
              v-bind="project"
          ...
          <a
            ...
            class="link text-xl md:text-2xl pb-1"
          >
      ...
      <footer class="relative z-10 pt-48 pb-12">
        <div class="text-center pb-8">
          ...
          <a href="https://github.com/jasonliang512" class="social-link">
          ...
          <a href="https://dribbble.com/jasonliang512" class="social-link">
            <svg viewBox="0 0 512 512" fill="currentColor">
              <path
...
.mode-dark .social-link {
  @apply text-gray-600;
}

.mode-dark .social-link:hover {
  @apply text-gray-400;
}
